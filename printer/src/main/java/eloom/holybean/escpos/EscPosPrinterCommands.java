...
public class EscPosPrinterCommands {
     ...
     *
     * @param align Set the alignment. Use EscPosPrinterCommands.TEXT_ALIGN_... constants
    ...
    /**
     * Forces the transition to a new line and set the alignment of text with the connected printer.
     *
     * @param align Set the alignment. Use EscPosPrinterCommands.TEXT_ALIGN_... constants
     * @return Fluent interface
     */
