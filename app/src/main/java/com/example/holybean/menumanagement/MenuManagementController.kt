package com.example.holybean.menumanagement
...
import com.example.holybean.common.PasswordDialog
...
@AndroidEntryPoint
class MenuManagementController : Fragment() {

    @Inject
    lateinit var service: MenuManagementService
